...
const PRODUCTS = [
  {
    ...
    description:
      "Midnight Velvet é uma fragrância misteriosa e sofisticada, perfeita para a noite. Com notas de topo de bergamota e pimenta rosa, evoluindo para um coração de jasmim e baunilha, e finalizando com uma base rica de sândalo e patchouli. Uma verdadeira joia da perfumaria.",
    price: 229.9,
    originalPrice: null,
    badge: "Novo",
  ...
  },
  {
    ...
    description:
      "Golden Essence captura a luz do sol em um frasco. Uma combinação radiante de flores brancas e madeiras nobres. Elegante, atemporal e marcante, é a assinatura perfeita para quem busca distinção e classe.",
    price: 249.9,
    badge: "Bestseller",
  ...
  },
  {
    ...
    description:
      "Uma edição limitada criada com os ingredientes mais raros do mundo. Rare Bloom traz a exclusividade da Rosa de Grasse combinada com o Oud mais puro. Uma fragrância para colecionadores e amantes da alta perfumaria.",
    price: 349.9,
    badge: "Limitado",
  ...
  },
  {
    ...
    description:
      "Sinta a brisa do mar com Ocean Breeze. Uma fragrância leve e energizante que combina notas aquáticas com limão siciliano e cedro. Ideal para os dias quentes de verão.",
    price: 159.9,
    rating: 4,
    reviews: 32,
    ...
    features: [
      "Frescor imediato",
      "Ideal para o calor",
      "Família olfativa: Aquático Cítrico",
    ],
    category: "cologne",
  ...
  },
  {
    ...
    description:
      "Noir Intense é para quem não tem medo de ousar. Couro, tabaco e especiarias se unem em uma dança olfativa inesquecível. Uma fragrância que deixa rastro e marca presença.",
    price: 289.9,
    rating: 5,
    reviews: 56,
    ...
    features: [
      "Alta fixação",
      "Notas de couro",
      "Família olfativa: Couro Especiado",
    ],
    category: "perfume",
    gender: "MASCULINO" as const,
    totalSold: 210,
  ...
  },
  {
    ...
    description:
      "Royal Amber é uma homenagem à realeza. Uma fragrância quente, envolvente e profundamente luxuosa. Notas de âmbar, especiarias douradas e um toque de mel criam uma aura de poder e sofisticação.",
    price: 319.9,
    badge: "Exclusivo",
  ...
  },
  {
    ...
    description:
      "Aurora Boreal é uma celebração de luzes e cores. Notas cítricas efervescentes encontram o calor do âmbar e a sensualidade do almíscar branco. Uma fragrância que desperta os sentidos e ilumina quem a usa.",
    price: 199.9,
    originalPrice: 259.9,
    badge: "Oferta",
    badgeVariant: "destructive",
    ...
    features: [
      "Edição Especial",
      "Notas luminosas",
      "Família olfativa: Cítrico Ambarado",
    ],
    category: "perfume",
    gender: "UNISSEX" as const,
    totalSold: 500,
  ...
  },
  {
    ...
    name: "Jardim Secreto",
    shortDescription:
      "Um refúgio floral escondido entre notas verdes e frescas",
    description:
      "Descubra o mistério de um jardim proibido. Jardim Secreto combina a delicadeza da peônia e do lírio do vale com o frescor do orvalho da manhã. Romântico, etéreo e absolutamente encantador.",
    price: 179.9,
    originalPrice: 219.9,
    badge: "Desconto",
    badgeVariant: "secondary",
  ...
  },
  {
    ...
    description:
      "Elixir Noturno é puro mistério e sedução. A riqueza do cacau e da fava tonka se mistura com a profundidade do patchouli e um toque de pimenta preta. Perfeito para noites inesquecíveis.",
    price: 219.9,
    originalPrice: 289.9,
    badge: "Imperdível",
    badgeVariant: "default",
...
async function main() {
  ...
  for (const coupon of COUPONS) {
    ...
    console.log(
      `Created/Updated coupon: ${result.code} (${result.type} ${result.value}${result.type === "PERCENTAGE" ? "%" : ""})`,
    );
  }

  // ─── Usuário de teste (E2E) ──────────────────────────────────────────────────
  // Só em ambientes não-prod. O e2e forja o JWT de sessão com este id/email fixos.
